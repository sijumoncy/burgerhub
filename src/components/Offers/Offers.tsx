  ...
  return (
    <section id="offers">
      <div className="container flex flex-col gap-5 | tabM:flex-row">
        {offerData.map((offer) => (
          <div key={offer.id} className="bg-black/5 flex flex-col p-5 rounded-lg group/card | tabM:flex-row tabM:item-center 
            ...
            <div className="space-y-2 pt-5 | tabM:pt-0">
              ...
              <p className="para__text">{offer.tagline}</p>
              <a href={offer.link} className="text-xs text-seconday">
                Buy It
              </a>
            </div>
          </div>
