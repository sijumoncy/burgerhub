...
function Navbar() {
  ...
  return (
    <nav className={`max-w-5xl mx-auto relative h-14 flex justify-between items-center px-5 bg-white
      ${scrollValue > 50 && "border-b border-secondar"}`}>
      <div className="">
      ...
      <div
        className={`${
          openNav ? "" : "hidden"
        } absolute top-0 left-0 w-full py-14 border-b border-seconday bg-white
      ...
      >
        ...
        <HiX
          className="absolute top-[1rem] right-4 text-xl cursor-pointer | tabM:hidden"
